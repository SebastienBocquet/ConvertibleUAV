...
// struct ADchannel udb_xaccel, udb_yaccel, udb_zaccel; // x, y, and z
// accelerometer channels
// struct ADchannel udb_xrate,  udb_yrate,  udb_zrate;  // x, y, and z gyro
// channels
...
void MPU6000_init16(callback_fptr_t fptr) {
  ...
  //    conservative and only run the SPI bus at half the maximum specified
  // speed
  /*
  #if (MIPS == 70)
...
//	writeMPUSPIreg16(MPUREG_ACCEL_CONFIG, BITS_FS_8G); // Accel scale g = 4096
   ...
   */
  /*
         _TRISMPUINT = 1; // this is probably already taken care of in mcu.c for
 most boards
