...
//#define I2C1BRGVAL ((FREQOSC/(CLK_PHASES *I2C1FSCL))-(FREQOSC/(CLK_PHASES *
//10000000)))-1
#define I2C2BRGVAL 60  // 200 Khz
#define I2C2_NORMAL                         \
  (((I2C2CON & 0b0000000000011111) == 0) && \
   ((I2C2STAT & 0b0100010011000001) == 0))
...
void I2C2_trigger_service(void) { trigger_event(I2C2_service_handle); }
...
static void isr_doneWrite(void) {
  I2C2_Busy = false;
  if (x.callback != NULL) x.callback(true);
}
...
static void isr_failed(void) {
  ...
  I2C2CONbits.PEN = 1;
  I2C2_Busy = false;
  if (x.callback != NULL) x.callback(false);
}
