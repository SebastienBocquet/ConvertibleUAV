...
void rxBarometer(barometer_callback_funcptr callback)  // service the barometer
{
	...
	if (barPause == 0)
	{
		...
		case 4:
            ...
            //at HEARTBEAT_Hz=80Hz, it gives 25ms to write on device. For BMP085, it is ok for OSS=0, 1 or 2
...
#define MS5611_ADDRESS 0xEC   // Module address write mode 1110 1110 bit1=CSB bit0=0 write
...
void MS5611_compute_PT(int32_t * pressure,
                       int16_t * temperature);
...
void rxBarometer(barometer_callback_funcptr callback)  // service the barometer
{
	...
	if (barCalibPause == 0)
	{
		...
		case 1:
			...
			break;
		case 2: 
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib1, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 3:
            C[0]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib2, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);

			break;
        case 4:
            C[1]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib3, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);

			break;
        case 5:
            C[2]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib4, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 6:
            C[3]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib5, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 7:
            C[4]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib6, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 8:
            C[5]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib7, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 9:
            C[6]=bc.c0;
            I2C_Read(MS5611_ADDRESS, ms5611read_barCalib8, 1, bc.buf, 2, &ReadBarCalib_callback, I2C_MODE_WRITE_ADDR_READ);
			break;
        case 10:
            C[7]=bc.c0;
            break;
		...
		case 11:
			...
			break;
        case 12:
            I2C_Read(MS5611_ADDRESS, ms5611read_barData, 1, barData, 3, &ReadBarTemp_callback, I2C_MODE_WRITE_ADDR_READ);
            break;
        case 13:
            barCalibPause=1;
            ...
            break;
        case 14:
            I2C_Read(MS5611_ADDRESS, ms5611read_barData, 1, barData, 3, &ReadBarPres_callback, I2C_MODE_WRITE_ADDR_READ);
            break;
		default:
			barMessage = 0;
			break;
...
void MS5611_compute_PT(int32_t * pres,
                       int16_t * temp){
