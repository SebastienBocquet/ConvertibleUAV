...
//definition of a velocity, start altitude and end altitude for the vertical landing and take-off segments
//{velocity; alt_min; alt_end; duration; is_target_alt; behavior_flag; manoeuvre; };
