...
// Airspeeds in m/s
#define MINIMUM_GROUNDSPEED 5.0
#define MINIMUM_AIRSPEED 12.0
#define MAXIMUM_AIRSPEED 20.0
#define CRUISE_AIRSPEED 15.0  // Gliding airspeed when aircraft is level
...
#define AIRSPEED_PITCH_KI \
  0.04  // Integrataion rate.  High = unstable, low = slow response.
#define AIRSPEED_PITCH_KI_MAX \
  5.0  // Limit of integration control in degrees.  Start with 5.0.
