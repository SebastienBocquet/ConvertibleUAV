...
const mavlink_parameter_parser mavlink_parameter_parsers[] = {
    ...
    {&mavlink_send_param_gyroscale_Q14, &mavlink_set_param_gyroscale_Q14,
     MAVLINK_TYPE_FLOAT},
    {&mavlink_send_int_circular, &mavlink_set_int_circular,
     MAVLINK_TYPE_INT32_T},
    {&mavlink_send_dm_airspeed_in_cm, &mavlink_set_dm_airspeed_from_cm,
     MAVLINK_TYPE_INT32_T},
    {&mavlink_send_dm_airspeed_in_m, &mavlink_set_dm_airspeed_from_m,
     MAVLINK_TYPE_FLOAT},
    {&mavlink_send_cm_airspeed_in_m, &mavlink_set_cm_airspeed_from_m,
     MAVLINK_TYPE_FLOAT},
    {&mavlink_send_frame_anglerate, &mavlink_set_frame_anglerate,
     MAVLINK_TYPE_INT32_T},
...
const mavlink_parameter mavlink_parameters_list[] = {
    {"PID_HOVERTVKP",
     ...
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&hoverthrottlevzkp,
     sizeof(hoverthrottlevzkp)},
    {"PID_HOVERTVKI",
     {.param_float = 0.0},
     {.param_float = 0.5},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&hoverthrottlevzki,
     sizeof(hoverthrottlevzki)},
    {"PID_HOVERTAKP",
     {.param_float = 0.0},
     {.param_float = 0.5},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&hoverthrottleacczkp,
     sizeof(hoverthrottleacczkp)},
    {"PID_HOVERTAKI",
     {.param_float = 0.0},
     {.param_float = 0.5},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&hoverthrottleacczki,
     sizeof(hoverthrottleacczki)},
    {"PID_HOVERTOFF",
     {.param_float = 0.0},
     {.param_float = 1.},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&hoverthrottleoffset,
     sizeof(hoverthrottleoffset)},
    {"PID_HOVERLIMVZ",
     {.param_int32 = 0.0},
     {.param_int32 = 500.},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&limittargetvz,
     sizeof(limittargetvz)},
    {"PID_HOVERLIMAZ",
     {.param_int32 = 0.0},
     {.param_int32 = 2500.},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&limittargetaccz,
     sizeof(limittargetaccz)},
    {"PID_HOVERFILTA",
     {.param_int32 = 0.0},
     {.param_int32 = 40.},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&invdeltafilteraccel,
     sizeof(invdeltafilteraccel)},
    {"PID_ROLLKP",
     {.param_float = 0.0},
     {.param_float = 0.5},
     UDB_TYPE_Q14,
    ...
    {"PID_RUDELEVGAIN",
     ...
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&rudderElevMixGain,
     sizeof(rudderElevMixGain)},
    {"PID_ROLLKPRUD",
     {.param_float = 0.0},
     {.param_float = 0.5},
     UDB_TYPE_Q14,
    ...
    {"MAG_OFFSET0",
     ...
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_magOffset[0],
     sizeof(udb_magOffset[0])},
    {"MAG_OFFSET1",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_magOffset[1],
     sizeof(udb_magOffset[1])},
    {"MAG_OFFSET2",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_magOffset[2],
    ...
    {"IMU_ZACCEL_OFF",
     ...
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_zaccel.offset,
     sizeof(udb_zaccel.offset)},
    {"IMU_XGYRO_OFF",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_xrate.offset,
     sizeof(udb_xrate.offset)},
    {"IMU_YGYRO_OFF",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_yrate.offset,
     sizeof(udb_yrate.offset)},
    {"IMU_ZGYRO_OFF",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_zrate.offset,
     sizeof(udb_zrate.offset)},
    {"IMU_VREF_OFF",
     {.param_int32 = -32767},
     {.param_int32 = 32767},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&udb_vref.offset,
     sizeof(udb_vref.offset)},
    {"TH_H_TARGET_MIN",
     {.param_int32 = 0},
     {.param_int32 = 1},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&height_target_min,
     sizeof(height_target_min)},
    {"TH_H_TARGET_MAX",
     {.param_int32 = 0},
     {.param_int32 = 1},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&height_target_max,
     sizeof(height_target_max)},
    {"TH_H_MARGIN",
     {.param_int32 = 1},
     {.param_int32 = 500},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&height_margin,
     sizeof(height_margin)},
    {"TH_T_HOLD_MIN",
     {.param_float = 0},
     {.param_float = 1},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&alt_hold_throttle_min,
     sizeof(alt_hold_throttle_min)},
    {"TH_T_HOLD_MAX",
     {.param_float = 0},
     {.param_float = 1},
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&alt_hold_throttle_max,
     sizeof(alt_hold_throttle_max)},
    {"TH_P_HOLD_MIN",
     {.param_int32 = -89},
     {.param_int32 = 0},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&alt_hold_pitch_min,
     sizeof(alt_hold_pitch_min)},
    {"TH_P_HOLD_MAX",
     {.param_int32 = 0},
     {.param_int32 = 89},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&alt_hold_pitch_max,
     sizeof(alt_hold_pitch_max)},
    {"TH_P_HIGH",
     {.param_int32 = 0},
     {.param_int32 = 89},
     UDB_TYPE_INT,
     PARAMETER_READWRITE,
     (void*)&alt_hold_pitch_high,
    ...
    {"ASPD_P_RATE_LIM",
     ...
     PARAMETER_READWRITE,
     (void*)&airspeed_pitch_adjust_rate,
    ...
    {"ASPD_P_KI",
     ...
     UDB_TYPE_Q14,
     PARAMETER_READWRITE,
     (void*)&airspeed_pitch_ki,
     sizeof(airspeed_pitch_ki)},
    {"ASPD_P_KI_LIMIT",
     {.param_int32 = 0.0},
     {.param_int32 = 45.0},
     UDB_TYPE_DCM_ANGLE,
     PARAMETER_READWRITE,
     (void*)&airspeed_pitch_ki_limit,
     sizeof(airspeed_pitch_ki_limit)}, };

const uint16_t count_of_parameters_list =
    sizeof(mavlink_parameters_list) / sizeof(mavlink_parameter);
