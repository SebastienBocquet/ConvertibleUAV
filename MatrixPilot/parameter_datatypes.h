...
extern void mavlink_set_param_gyroscale_Q14(mavlink_param_union_t setting,
                                            int16_t i);
...
extern void mavlink_set_dm_airspeed_from_cm(mavlink_param_union_t setting,
                                            int16_t i);

extern void mavlink_send_dm_airspeed_in_m(int16_t i);
extern void mavlink_set_dm_airspeed_from_m(mavlink_param_union_t setting,
                                           int16_t i);

extern void mavlink_send_cm_airspeed_in_m(int16_t i);
extern void mavlink_set_cm_airspeed_from_m(mavlink_param_union_t setting,
                                           int16_t i);

extern void mavlink_send_frame_anglerate(int16_t i);
extern void mavlink_set_frame_anglerate(mavlink_param_union_t setting,
                                        int16_t i);
