...
uint16_t get_geo_heading_angle() {
  ...
  int16_t accum = rect_to_polar(&matrix_accum);  // binary angle (0 to 180, -1
                                                 // to -179 for complete 360
                                                 // degrees)
  int16_t angle = (accum * 180 + 64) >>
                  7;  // Angle measured counter clockwise, 0=Geographic North
