...
// HOVER_ANGLE_TOWARDS_WP is the max angle in degrees to pitch the nose down towards the WP while navigating
// HOVER_NAV_MAX_ANGLE_RADIUS is the radius around a waypoint in meters, within which the HOVER_PITCH_TOWARDS_WP
