...
#define SONAR_PITCH_OUTPUT_CHANNEL          CHANNEL_8
#define ELEVATOR_OUTPUT_CHANNEL             CHANNEL_6
...
// HOVER_ANGLE_TOWARDS_WP is the max angle in degrees the nose down towards the WP while navigating
// HOVER_NAV_MAX_PITCH_RADIUS is the radius around a waypoint in meters, within which the HOVER_ANGLE_TOWARDS_WP
...
#define SONAR_PITCH_SERVO_RANGE               90   // servo angular range in degrees at max pwm
#define SONAR_PITCH_SERVO_THROW               90   // servo angular range in degrees at max pwm
#define SONAR_PITCH_SERVO_MAX                 0    // maximum servo angle in degrees 
#define SONAR_PITCH_SERVO_MIN                 -60     // minimum servo angle in degrees 
#define SONAR_PITCH_OFFSET_CENTRED            0     // offset angle in degrees, corresponding to servo angle at zero pwm           
...
#define CAM_TAN_PITCH_IN_STABILIZED_MODE    32767   // 1443 is 5 degrees of pitch. Example: 15 degrees is 4389
#define CAM_YAW_IN_STABILIZED_MODE          0       // in degrees relative to the plane's yaw axis.    Example: 0

// All number should be integers
#define CAM_PITCH_SERVO_THROW               105 //110      // Camera lens rotation at maximum PWM change (2000 to 4000), in degrees.          
#define CAM_PITCH_SERVO_MAX                 180     // Max pitch up that plane can tilt and keep camera level, in degrees.  
#define CAM_PITCH_SERVO_MIN                 0       // Max pitch down that plane can tilt and keep camera level, in degrees. 
#define CAM_PITCH_OFFSET_CENTRED            125     // Offset in degrees of servo that results in a level camera.           
...
#define CAM_YAW_SERVO_THROW                 100     // Camera yaw movement for maximum yaw PWM change (2000 to 4000) in Degrees. 
#define CAM_YAW_SERVO_MAX                   180     // Max positive yaw of camera relative to front of plane in Degrees.              
#define CAM_YAW_SERVO_MIN                   0       // Min reverse  yaw of camera relative to front of plane in Degrees.   
#define CAM_YAW_OFFSET_CENTRED              90      // Yaw offset in degrees that results in camera pointing forward. 
...
#define CAM_TESTING_YAW_ANGLE               60      // e.g. 90 degrees. Will try to swing 90 degrees left, then 90 degrees right
