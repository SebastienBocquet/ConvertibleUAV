...
#define ROLL_MOTOR_CHANNEL_REVERSED 1
#define PITCH_MOTOR_CHANNEL_REVERSED 0
#define MOTOR_TILT_CHANNEL_REVERSED 0
#define MOTOR_TILT_YAW_REVERSED 1
...
#define MAX_YAW_RATE 51  // maximum yaw rate, degrees per second, must be between 50 and 500
      // degrees/second
